      ...
      <div className="glass-panel rounded-3xl p-8 w-full max-w-md shadow-2xl relative z-10 animate-fade-in border border-white/10">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-4 md:py-5 bg-black/40 border border-white/10 rounded-2xl text-white focus:outline-none focus:border-deep-purple focus:bg-black/60 transition-all placeholder:text-white/20 text-base"
          ...
          <div>
            ...
            <div className="relative group">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-4 md:py-5 bg-black/40 border border-white/10 rounded-2xl text-white focus:outline-none focus:border-deep-purple focus:bg-black/60 transition-all placeholder:text-white/20 text-base"
          ...
          <div>
            ...
            <div className="relative group">
              ...
              <input
                ...
                className="w-full pl-12 pr-12 py-4 md:py-5 bg-black/40 border border-white/10 rounded-2xl text-white focus:outline-none focus:border-deep-purple focus:bg-black/60 transition-all placeholder:text-white/20 text-base"
                placeholder="••••••••"
                required
                minLength={6}
              />
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-5 bg-gradient-to-r from-deep-purple to-[#7B4B27] hover:brightness-110 text-white rounded-2xl font-bold shadow-lg shadow-deep-purple/20 transition-all transform hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed mt-2 min-h-[56px] text-base"
          >
