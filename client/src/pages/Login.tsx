    ...
    <div className="h-[100dvh] w-full bg-primary flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md glass-panel p-10 rounded-[3rem] border-white/5 relative z-10 animate-scale-in">
        <div className="text-center mb-10">
          <h1 className="text-4xl font-bold font-display mb-3 tracking-tight">Welcome Back</h1>
          <p className="text-white/40 text-lg">Continue your journey</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            <label className="block text-white/40 text-xs font-bold uppercase tracking-widest ml-4">Email</label>
            <div className="relative group">
              <Mail className="absolute left-6 top-1/2 -translate-y-1/2 text-white/20 group-focus-within:text-neon-purple transition-colors" size={20} />
              <input
                type="email"
                value={email}
                onChange={(e) => setEmail(e.target.value)}
                className="w-full pl-14 pr-6 py-5 bg-obsidian/40 border border-white/10 rounded-2xl text-white focus:outline-none focus:border-neon-purple focus:bg-obsidian/60 transition-all placeholder:text-white/10"
          ...
          <div className="space-y-2">
            <label className="block text-white/40 text-xs font-bold uppercase tracking-widest ml-4">Password</label>
            <div className="relative group">
              <Lock className="absolute left-6 top-1/2 -translate-y-1/2 text-white/20 group-focus-within:text-neon-purple transition-colors" size={20} />
              <input
                type="password"
                value={password}
        ...
        <div className="mt-10 space-y-8">
          <div className="relative flex items-center">
            ...
            <span className="px-4 text-white/20 text-xs font-bold uppercase tracking-widest">Or continue with</span>
            <div className="flex-1 border-t border-white/5"></div>
          </div>
        ...
        <p className="mt-10 text-center text-white/40 text-sm">
          New to UTH?{' '}
          <Link to="/signup" className="text-neon-purple hover:text-white font-bold transition-colors">
            Create Account
          </Link>
        </p>
      </div>
