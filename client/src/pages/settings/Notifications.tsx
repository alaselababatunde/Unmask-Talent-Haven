        ...
        <div className="min-h-[100dvh] bg-matte-black pb-24">
            <div className="max-w-2xl mx-auto px-4 md:px-6 py-6 md:py-8">
                <div className="flex items-center gap-3 mb-8">
                    ...
                    <h1 className="text-xl md:text-xl md:text-2xl font-bold text-accent-beige">Notifications</h1>
                </div>

                <div className="bg-white/5 rounded-2xl p-5 md:p-5 md:p-6 border border-white/10 space-y-7 md:space-y-6">
