            ...
            <div className="max-w-2xl mx-auto px-4 py-8">
                ...
                <div className="bg-white/5 rounded-2xl p-8 text-center border border-white/10">
                    <div className="w-16 h-16 bg-deep-purple/20 rounded-full flex items-center justify-center mx-auto mb-4">
                        <Shield size={32} className="text-deep-purple" />
                    </div>
                    <h2 className="text-xl font-bold text-white mb-2">Security & Permissions</h2>
                    <p className="text-accent-beige/60">Manage your password and account access.</p>
